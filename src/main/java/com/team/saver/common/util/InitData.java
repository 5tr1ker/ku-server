...
class ReviewData {
    ...
    public ReviewData(String data, String imageName, int score) {
        new ReviewData(data, new String[]{imageName} , score);
    }

    public ReviewData(String data, int score, String ...imageName) {
        new ReviewData(data, imageName , score);
    }
}
...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        storeData.add(new StoreData("피자나라 치킨공주", "치킨.피자.안주.주류", "Rectangle 2269.png", "리뷰 작성 시 음료 1개\n" + "무료 증정 이벤트 진행 중!" , Arrays.asList(review2_1, review2_2, review2_3)));

        ReviewData review3_1 = new ReviewData("오랜만에 장작집이 생각나서 다녀왓습니다. 전기구이와 비교할수없는 장작구이만의 맛은 여전하네요 ~ 맛있게 잘 먹고 갑니다", "chicken4.png" , 5);
        ReviewData review3_2 = new ReviewData("예약하고 방문하세요! 나오는데 오래걸립니다아 맛있고 맥주랑 잘어울림다", "chicken5.png" , 4);
        ReviewData review3_3 = new ReviewData("너무 맛있게 잘 먹었어요! 비빔국수랑 누룽지통닭이랑 조합이 짱입니다! 비빔국수 안 시켰으면 후회 할 뻔 했어요", "chicken6.png" , 5);
        storeData.add(new StoreData("태권치킨", "치킨.안주.주류", "Rectangle 2270.png", "선착순 100명 10% 할인\n" + "쿠폰 증정 이벤트 진행 중!", Arrays.asList(review3_1, review3_2, review3_3)));
        ...
        ReviewData review5_3 = new ReviewData("너무 맛있게 잘 먹었어요! 비빔국수랑 누룽지통닭이랑 조합이 짱입니다! 비빔국수 안 시켰으면 후회 할 뻔 했어요", "chicken9.png" , 5);
        storeData.add(new StoreData("BHC치킨", "치킨.안주.주류", "Rectangle 2412.png", "리뷰 작성 시 음료 1개\n" + "무료 증정 이벤트 진행 중! \n 대충 메세지 임을 알려줍니다. \n 이건 말도 안된다고", Arrays.asList(review5_1, review5_2, review5_3)));

        ReviewData review6_1 = new ReviewData("직원들은 조금 별로긴 했는데 살면서 먹은 족발중에 가장 맛있었음.", "bossam1.png" , 5);
        ReviewData review6_2 = new ReviewData("딱 상상하는 그 족발 맛과 막국수 맛을 구현하는 집.", "bossam2.png" , 4);
        ReviewData review6_3 = new ReviewData("족발 진짜맛있어요~~!!  한동안 주1회씩은 꼭먹었었오요 ㅋㅋㅋ  야들야들하고 기름지고 최고예여", "bossam3.png" , 5);
        storeData.add(new StoreData("장충동 왕족발보쌈", "족발.보쌈", "Rectangle 2413.png", "선착순 100명 10% 할인\n" + "쿠폰 증정 이벤트 진행 중! \n 대충 메세지 임을 알려줍니다. \n 이건 말도 안된다고 \n 아잇 정말 맛업ㅈㅅ어 죽겠네 ", Arrays.asList(review6_1, review6_2, review6_3)));

        ReviewData review7_1 = new ReviewData("데스크 직원분이 친절하시네요. 감자도 금방 한 것 같고", "burger1.png" , 5);
        ...
        ReviewData review7_3 = new ReviewData("다녀본 버거킹중 제일 나음 주문표상 요청사항 잘 반영함", "burger3.png" , 4);
        storeData.add(new StoreData("버거킹", "햄버거.음료", "Rectangle 2415.png", "첫 구매시 3,000원 \n" + "할인 이벤트 진행 중! \n 맛있게 드세오!" , Arrays.asList(review7_1, review7_2, review7_3)));

        ReviewData review8_1 = new ReviewData("못 먹는 야채가 있어서 지정한 야채만 넣어달라고 했더니 모.든.야.채 를 다 넣어주셨네요 ^^ 번창하시고 죽어도 갈 일 없을듯", "subway1.png" , 1);
        ReviewData review8_2 = new ReviewData("친절하신대.", "subway2.png" , 5);
        ReviewData review8_3 = new ReviewData("음..? 점심쯤에 종종 들렀는데 불친절한건 잘 못느꼈어요... 한적한 시간대에만 방문했을지도 모르겠네요", "subway3.png" , 5);
        storeData.add(new StoreData("서브웨이", "샌드위치.음료", "Rectangle 2416.png", "첫 구매시 3,000원 \n" + "할인 이벤트 진행 중!" , Arrays.asList(review8_1, review8_2, review8_3)));
        ...
        ReviewData review9_2 = new ReviewData("버거보다는 치즈스틱이 맛있음.", "burger5.png" , 5);
        ReviewData review9_3 = new ReviewData("진짜 ♩♬~ 맛없음 소스도 별로 없음 알바생 싸다구 ♩♬~ 때리고 싶음 거기다 다 못생김", "burger6.png" , 1);
        storeData.add(new StoreData("롯데리아", "햄버거.음료", "Rectangle 2417.png", "첫 구매시 3,000원 \n" + "할인 이벤트 진행 중! \n 맛있게 드세오!" , Arrays.asList(review9_1, review9_2, review9_3)));

        ReviewData review10_1 = new ReviewData("아이스크림 세로로 퍼주시는거 너무 좋았어요! 홍제역 베라는 정말 그지 같았는데, ", "icecream1.png" , 5);
        ReviewData review10_2 = new ReviewData("배라는 여기로 다녀야겠어요!! 아이스크림 예쁘게 꽉꽉 눌러담아주시고 친절하시고 빨라서 좋았습니다. 손님이 많아서 바빠보이셨는데도 신경써주셔서 감사해요", "icecream2.png" , 5);
        ReviewData review10_3 = new ReviewData("더워서 아이스크림 먹으러 왔는데 너무 추워서 아이스크림을 못 먹겠어요~~~~~남자 직원?분도 친절하신데요 추워서 별3개요~ 다른점은 별5개요", "icecream3.png" , 3);
        storeData.add(new StoreData("베스킨라빈스", "아이스크림.음료", "Rectangle 2419.png", "첫 구매시 3,000원 \n" + "할인 이벤트 진행 중! \n 맛있게 드세오! \n 그럼 맛없게 먹겠냐" , Arrays.asList(review10_1, review10_2, review10_3)));
        ...
        ReviewData review13_3 = new ReviewData("2인엽떡 넘 맛있게 잘먹고가요 친절하시고 감사합니다^^", "tteokbokki3.png" , 5);
        storeData.add(new StoreData("엽기떡볶이", "떡볶이.튀김.마라", "Rectangle 2199.png", "리뷰 작성 시 음료 1개\n" + "무료 증정 이벤트 진행 중! \n 대충 메세지 임을 알려줍니다. \n 이건 말도 안된다고", Arrays.asList(review13_1, review13_2, review13_3)));

        ReviewData review14_1 = new ReviewData("3마리에 소맥 3개 세명이 2차로 간단한 맥주 굿~", "chicken13.png" , 5);
        ReviewData review14_2 = new ReviewData("통닭이랑 못난이 감자 가성비 좋게 먹었습니다! 다만 가게 자체가 협소하고 위생에 있어 ㅎㅎ 감안하고 먹어야할 듯 합니다.", "chicken14.png" , 3);
        ReviewData review14_3 = new ReviewData("서빙하는 외국인이 불진철하고 기분이 나쁘게 만들었어요. 이런 서비스 진짜 처음이다 시설, 서비스 그냥 그럼 치킨은 싼맛에 먹는 정도 오히려 닭똥집은 맛있음", "chicken15.png" , 1);
        storeData.add(new StoreData("네네치킨", "치킨.안주.주류", "Rectangle 2272.png", "선착순 100명 10% 할인\n" + "쿠폰 증정 이벤트 진행 중! \n 대충 메세지 임을 알려줍니다. \n 이건 말도 안된다고 \n 아잇 정말 맛업ㅈㅅ어 죽겠네 ", Arrays.asList(review14_1, review14_2, review14_3)));
        ...
        ReviewData review15_2 = new ReviewData("순두부찌개를 주문했는데 너무 싱거웠습니다 과장 조금 보태서 따뜻한 맹물 떠먹는 것 같았어요 사람들은 굉장히 많았는데 아무래도 메뉴 선택이 잘못 된 듯", "restaurant2.png" , 1);
        ReviewData review15_3 = new ReviewData("this place it is really recommemdable for people who wanna try korean food around sicheong. they have a full card full of korean typical food.", "restaurant3.png" , 5);
        storeData.add(new StoreData("엄마집밥", "한식.국밥.주류", "Rectangle 2423.png", "\"선착순 100명 10% 할인\\n\" + \"쿠폰 증정 이벤트 진행 중! \\n 대충 메세지 임을 알려줍니다. \\n 이건 말도 안된다고 \\n 아잇 정말 맛업ㅈㅅ어 죽겠네 \n 어그로 끌지마라 임니니니니", Arrays.asList(review15_1, review15_2, review15_3)));
