...
public class FavoriteController {
    ...
    @GetMapping
    @Operation(summary = "내가 추가한 관심 가게 조회")
    public ResponseEntity findFavoriteMarketByUserEmail(@LogIn CurrentUser currentUser) {
    ...
    @DeleteMapping
    @Operation(summary = "내가 추가한 관심 가게 제거")
    public ResponseEntity deleteFavoriteMarketById(@LogIn CurrentUser currentUser, @RequestParam long marketId) {
